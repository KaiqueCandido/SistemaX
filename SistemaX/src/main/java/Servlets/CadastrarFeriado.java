 ...
 * @author NandaPC
 */
@WebServlet(name = "CadastrarFeriado", urlPatterns = {"/CadastrarFeriado"})
public class CadastrarFeriado extends HttpServlet {
