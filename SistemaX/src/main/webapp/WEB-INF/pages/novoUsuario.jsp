...
<div class="automatic dj-invisible" id="novoUser">
    <div class="dj-modal__menu">
        ...
        <div class="dj-text__center carregaImagem margin">
            ...
            <h6 class="result">${result}</h6>
            <div class="botoes-fechar dj-text__right">
                <button type="submit" class="mdl-button mdl-button mdl-button--colored mdl-button--raised" onclick="adicionarUsuarioAjax()">Cadastrar</button>
